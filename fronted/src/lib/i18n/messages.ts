...
export const messages = {
  en: {
    ...
    "settings.llm.heading": "AI Model & API",
    "settings.llm.subtitle":
      "Bring your own LLM. These credentials drive the research, deploy and analyse agents.",
    "settings.llm.apiBase": "API Base URL",
    "settings.llm.apiKey": "API Key",
    "settings.llm.apiKeyPlaceholder": "sk-…",
    "settings.llm.apiKeyKeep": "Leave blank to keep {masked}",
    "settings.llm.apiType": "API Type",
    "settings.llm.model": "Model",
    "settings.llm.edit": "Edit",
    "settings.llm.save": "Save & apply",
    "settings.llm.saving": "Saving…",
    "settings.llm.cancel": "Cancel",
    "settings.llm.empty": "Not configured yet — add your API to enable AI features.",
    "settings.llm.restarting": "Config saved. Restarting AI service…",
    "settings.llm.restartOk": "AI service restarted with the new configuration.",
    "settings.llm.restartFailed": "Saved, but the AI service failed to restart — relaunch the app.",
    "settings.llm.restartManual": "Saved. Restart the app for changes to take effect.",
    "settings.llm.error.badUrl": "Enter a valid http(s) API base URL",
    "settings.llm.error.noModel": "Model is required",
    "settings.llm.error.noKey": "API key is required",
    "settings.llm.error.loadFailed": "Could not load config: {message}",
    "settings.llm.error.saveFailed": "Could not save: {message}",
  ...
  zh: {
    ...
    "settings.llm.heading": "AI 模型与 API",
    "settings.llm.subtitle": "使用你自己的大模型。这些凭据驱动论文研究、部署与解析 Agent。",
    "settings.llm.apiBase": "API 地址",
    "settings.llm.apiKey": "API Key",
    "settings.llm.apiKeyPlaceholder": "sk-…",
    "settings.llm.apiKeyKeep": "留空则保留 {masked}",
    "settings.llm.apiType": "API 类型",
    "settings.llm.model": "模型",
    "settings.llm.edit": "编辑",
    "settings.llm.save": "保存并应用",
    "settings.llm.saving": "保存中…",
    "settings.llm.cancel": "取消",
    "settings.llm.empty": "尚未配置 —— 填入你的 API 即可启用 AI 功能。",
    "settings.llm.restarting": "配置已保存，正在重启 AI 服务…",
    "settings.llm.restartOk": "AI 服务已用新配置重启。",
    "settings.llm.restartFailed": "已保存，但 AI 服务重启失败 —— 请重启应用。",
    "settings.llm.restartManual": "已保存。重启应用后生效。",
    "settings.llm.error.badUrl": "请填写合法的 http(s) API 地址",
    "settings.llm.error.noModel": "模型不能为空",
    "settings.llm.error.noKey": "API Key 不能为空",
    "settings.llm.error.loadFailed": "无法加载配置：{message}",
    "settings.llm.error.saveFailed": "保存失败：{message}",
