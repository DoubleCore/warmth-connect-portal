...
export const messages = {
  en: {
    ...
    "paper.analysis.generate": "Generate with AI",
    "paper.analysis.regenerate": "Regenerate",
    "paper.analysis.analyzing": "Analyzing paper…",
    "paper.analysis.error": "Failed to generate analysis. Please try again.",
  ...
  zh: {
    ...
    "paper.analysis.generate": "AI 生成分析",
    "paper.analysis.regenerate": "重新生成",
    "paper.analysis.analyzing": "正在分析论文…",
    "paper.analysis.error": "生成分析失败，请重试。",
